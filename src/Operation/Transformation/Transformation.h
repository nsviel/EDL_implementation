...
public:
  ...
  // Rotation
  mat4 make_rotation(Set* set, vec3 COM, vec3 angles);
  void make_rotation(Set* set, vec3 R, string direction);
  ...
  // Scaling
  void make_scaling(Set* set, float scaling);
  void make_scaling(Object* object, float scaling);

  // Transformation
  void make_Transformation(Object* object, vec3 COM, mat4 transfMat);
  ...
  mat4 make_transformation_attribut(Object* object, vec3 COM, mat4 transformation);
