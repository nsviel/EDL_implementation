...
constexpr image_layout IMAGE_LAYOUT_COLOR = VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL;
constexpr image_layout IMAGE_LAYOUT_DEPTH = VK_IMAGE_LAYOUT_DEPTH_STENCIL_ATTACHMENT_OPTIMAL;
constexpr image_layout IMAGE_LAYOUT_SHADER = VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL;
constexpr image_layout IMAGE_LAYOUT_TRANSFER = VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL;
