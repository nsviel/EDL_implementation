...
void VK_swapchain::recreate_swapChain(){
  ...
  //Clean old values
  vk_frame->clean_frame_swapchain(vk_param->renderpass_scene.vec_frame_swapchain);
  this->clean_swapchain();

  //Recreate values
  vk_physical_device->compute_extent();
  this->create_swapchain();
  vk_frame->create_frame_swapchain(vk_param->renderpass_scene.vec_frame_swapchain);
