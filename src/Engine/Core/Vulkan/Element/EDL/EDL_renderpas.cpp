...
EDL_renderpas::EDL_renderpas(VK_engine* vk_engine){
  //---------------------------
...
//Main function
void EDL_renderpas::init_renderpass(Struct_renderpass* renderpass){
...
//Pipeline
void EDL_renderpas::create_pipeline_edl(Struct_renderpass* renderpass){
  //---------------------------
