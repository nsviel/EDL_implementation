...
//Main function
Data_file* Parser_VLP16::parse_packet(std::vector<int> packet_dec){
...
//Subfunctions
bool Parser_VLP16::parse_header(std::vector<int>& packet_dec){
  //---------------------------
...
void Parser_VLP16::parse_vector(std::vector<int> packet){
  blocks.clear();
  //---------------------------
...
//Subsubfunctions
std::vector<float> Parser_VLP16::calc_timing_offsets(){
...
void Parser_VLP16::make_supressElements(std::vector<glm::vec3>& vec, std::vector<int> idx){
...
void Parser_VLP16::make_supressElements(std::vector<float>& vec, std::vector<int> idx){
  if(idx.size() == 0)return;
  //---------------------------
