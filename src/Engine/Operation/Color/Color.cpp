...
void Color::make_colorization(Set* set, int ID_object){
...
//Color cloud functions
void Color::set_color_new(Set* set, vec4 RGBA){
...
void Color::set_color_RGB(Set* set){
  for(int i=0; i<collection->list_obj.size(); i++){
    Cloud* cloud = (Cloud*)*next(collection->list_obj.begin(), i);
...
void Color::set_color_I(Set* set){
  for(int i=0; i<collection->list_obj.size(); i++){
    Cloud* cloud = (Cloud*)*next(collection->list_obj.begin(), i);
    vector<vec4>& RGB_obj = cloud->rgb;
    vector<float>& Is = cloud->Is;
...
void Color::set_color_random(Set* set){
  for(int i=0; i<collection->list_obj.size(); i++){
    Cloud* cloud = (Cloud*)*next(collection->list_obj.begin(), i);
    vector<vec4>& RGB = cloud->rgb;
    //---------------------------
...
void Color::set_color_initial(Set* set){
  for(int i=0; i<collection->list_obj.size(); i++){
    Cloud* cloud = (Cloud*)*next(collection->list_obj.begin(), i);
